...
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(42)1000;
...
const char     CRYPTONOTE_NAME[]                             = "Cryptofriendsnetwork";
...
const char* const SEED_NODES[] = { "155.138.206.154:28388", "45.76.60.108:28388" };
